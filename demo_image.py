...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Predicting with audio and given image guidance')
    ...
    parser.add_argument("--image", type=str, default="assets/image/01-01-03-02-01-01-24.png")
